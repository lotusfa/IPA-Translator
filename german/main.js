/**
 * German IPA Translator - Refactored to use shared ipa-core module
 */
...
/**
 * Load database (static path for German)
 */
function loadDatabase() {
  loadIPADatabase({
    basePath: '../json/de.json',
    onSuccess: (lookup) => {
      IPA_DB = lookup;
      translate();
    },
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Initialize TTS button (German)
  initSpeakButton({ language: 'de-DE' });
