/**
 * Norwegian IPA Translator - Refactored to use shared ipa-core module
 */
...
/**
 * Load database (static path for Norwegian Bokmål)
 */
function loadDatabase() {
  loadIPADatabase({
    basePath: '../json/nb.json',
    onSuccess: (lookup) => {
      IPA_DB = lookup;
      translate();
    },
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Initialize TTS button (Norwegian Bokmål)
  initSpeakButton({ language: 'nb-NO' });
