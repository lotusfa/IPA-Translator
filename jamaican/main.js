/**
 * Jamaican IPA Translator - Refactored to use shared ipa-core module
 */
...
/**
 * Load database (static path for Jamaican)
 */
function loadDatabase() {
  loadIPADatabase({
    basePath: '../json/jam.json',
    onSuccess: (lookup) => {
      IPA_DB = lookup;
      translate();
    },
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Initialize TTS button (Jamaican Patois)
