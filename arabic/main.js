/**
 * Arabic IPA Translator - Refactored to use shared ipa-core module
 */
...
/**
 * Load database (static path for Arabic)
 */
function loadDatabase() {
  loadIPADatabase({
    basePath: '../json/ar.json',
    onSuccess: (lookup) => {
      IPA_DB = lookup;
      translate();
    },
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Initialize TTS button (Arabic)
  initSpeakButton({ language: 'ar-SA' });
