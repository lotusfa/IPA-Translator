/**
 * Finnish IPA Translator - Refactored to use shared ipa-core module
 */
...
/**
 * Load database (static path for Finnish)
 */
function loadDatabase() {
  loadIPADatabase({
    basePath: '../json/fi.json',
    onSuccess: (lookup) => {
      IPA_DB = lookup;
      translate();
    },
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Initialize TTS button (Finnish)
  initSpeakButton({ language: 'fi-FI' });
