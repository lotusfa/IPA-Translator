/**
 * Swedish IPA Translator - Refactored to use shared ipa-core module
 */
...
/**
 * Load database (static path for Swedish)
 */
function loadDatabase() {
  loadIPADatabase({
    basePath: '../json/sv.json',
    onSuccess: (lookup) => {
      IPA_DB = lookup;
      translate();
    },
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Initialize TTS button (Swedish)
  initSpeakButton({ language: 'sv-SE' });
